...
class AdminTokenService
{
     ...
     * @date 2021/7/2 20:25
     */
    public static function setToken($adminId, $terminal, int $multipointLogin = 1): mixed
    {
        $time = time();
        $adminSession = (new AdminSession())->where([['admin_id', '=', $adminId], ['terminal', '=', $terminal]])->find();
