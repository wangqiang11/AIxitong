...
class AdminLogic extends BaseLogic
{
    ...
    public static function edit(array $params): bool
    {
        ...
        try {
            ...
            if ($params['disable'] == 1 || $editRole) {
                $tokenArr = (new AdminSession())->where('admin_id', $params['id'])->select()->toArray();
    ...
    public static function delete(array $params): bool
    {
        ...
        $modelAdmin->startTrans();
        try {
            $admin = $modelAdmin->findOrEmpty($params['id']);
     ...
     */
    public static function detail($params, string $action = 'detail'): array
    {
        $admin = (new Admin())
            ->field([
        ...
        if ($admin['id'] == 1 && empty($admin['role_id'])) {
            $admin['role_id'] = [0];
        }
     ...
     * @date 2022/4/8 17:54
     */
    public static function editSelf($params): Admin
    {
        $data = [
            'id' => $params['admin_id'],
            'name' => $params['name'],
