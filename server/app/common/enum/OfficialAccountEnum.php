...
class OfficialAccountEnum
{
     ...
     */
    public static function getReplyType($type): string
    {
     ...
     */
    public static function getContentTypeDesc($value = true): array|string
    {
        $desc = [
     ...
     */
    public static function getReplyTypeDesc($value = true): array|string
    {
        $desc = [
     ...
     */
    public static function getMatchingTypeDesc($value = true): array|string
    {
        $desc = [
