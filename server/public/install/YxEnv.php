...
class YxEnv
{
    ...
    public function putEnv($envFilePath, array $databaseEnv)
    {
        $applyDbEnv = [
            ...
            'PGSQL.HOSTNAME' => $databaseEnv['pg_host'],
            'PGSQL.DATABASE' => $databaseEnv['pg_name'],
            'PGSQL.USERNAME' => $databaseEnv['pg_user'],
            'PGSQL.PASSWORD' => $databaseEnv['pg_password'],
            'PGSQL.HOSTPORT' => $databaseEnv['pg_port'],
            'PGSQL.PREFIX'   => $databaseEnv['pg_prefix'],

            'CACHE.HOST'     => $databaseEnv['redis_host'],
            'CACHE.PORT'     => $databaseEnv['redis_port'],
            'CACHE.PASSWORD' => $databaseEnv['redis_password'],

            'QUEUE.HOST'     => $databaseEnv['redis_host'],
            'QUEUE.PORT'     => $databaseEnv['redis_port'],
            'QUEUE.PASSWORD' => $databaseEnv['redis_password']
        ];
