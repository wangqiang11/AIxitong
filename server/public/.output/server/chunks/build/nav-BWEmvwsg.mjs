...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const navList = computed(() => {
      var _a;
      return ((_a = appStore.pageAside.nav) == null ? void 0 : _a.filter((item) => Number(item.is_show) === 1)) || [];
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "menu" }, _attrs))} data-v-818826ac>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("layouts/components/aside/nav.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const Nav = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-818826ac"]]);

export { Nav as default };
//# sourceMappingURL=nav-BWEmvwsg.mjs.map
