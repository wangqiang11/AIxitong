import { defineComponent, computed, watch, provide, reactive, toRefs, openBlock, createElementBlock, normalizeClass, unref, renderSlot, inject, ref, createVNode, Fragment, useSlots, withCtx, createBlock, resolveDynamicComponent, normalizeStyle, createTextVNode, toDisplayString, createCommentVNode, createElementVNode, TransitionGroup, nextTick } from 'vue';
import { h as buildProps, s as componentSizes, j as definePropType, v as useFormSize, i as useNamespace, o as debugWarn, aS as formContextKey, ae as formItemContextKey, t as throwError, a1 as useId, m as addUnit$1, a0 as isBoolean, aT as getProp, w as withInstall, q as withNoopInstall, _ as _export_sfc } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose }) {
    ...
    const labelStyle = computed(() => {
      ...
      const labelWidth = addUnit$1(props.labelWidth || (formContext == null ? void 0 : formContext.labelWidth) || "");
      if (labelWidth)
...
//# sourceMappingURL=index-DLL0sEcv.mjs.map
