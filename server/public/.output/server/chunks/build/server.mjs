import { hasInjectionContext, inject, version as version$1, ref, watchEffect, watch, getCurrentInstance, toRef, isRef, defineComponent, provide, createElementBlock, isVNode, computed, unref, onScopeDispose, shallowRef, renderSlot, openBlock, mergeProps, useAttrs as useAttrs$1, useSlots, nextTick, createCommentVNode, Fragment, normalizeClass, createElementVNode, createBlock, withCtx, resolveDynamicComponent, withModifiers, createVNode, toDisplayString, normalizeStyle, Transition, withDirectives, vShow, reactive, h, shallowReactive, toRefs, Suspense, useSSRContext, Text, withAsyncContext, createApp, effectScope, getCurrentScope, isReactive, toRaw, warn, render, onErrorCaptured, onServerPrefetch, defineAsyncComponent, markRaw, isReadonly, isShallow, resolveComponent, withKeys, createTextVNode } from 'vue';
import { $ as $fetch, h as hasProtocol, i as isScriptProtocol, k as joinURL, w as withQuery, c as createError$1, l as klona, p as parse, m as getRequestHeader, n as defu, s as sanitizeStatusCode, o as destr, q as isEqual, r as setCookie, t as getCookie, v as deleteCookie, x as getContext, y as createHooks } from '../nitro/nitro.mjs';
import { b as baseURL } from '../routes/renderer.mjs';
import { CapoPlugin, getActiveHead } from 'unhead';
import { defineHeadPlugin, composableNames } from '@unhead/shared';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
import { isObject, merge, isFunction as isFunction$1 } from 'lodash-es';
import { useLocalStorage, isClient, useEventListener, useResizeObserver, useTimeoutFn, useWindowSize, watchThrottled } from '@vueuse/core';
import wx from 'weixin-js-sdk';
import { isArray, isObject as isObject$1, camelize, isString, hasOwn, NOOP, isFunction, hyphenate } from '@vue/shared';
import { isNil, get, set, fromPairs, pick } from 'lodash-unified';
...
const navigateTo = (to, options) => {
  ...
  const isExternal2 = (options == null ? void 0 : options.external) || isExternalHost;
  if (isExternal2) {
  ...
  const nuxtApp = useNuxtApp();
  {
    if (nuxtApp.ssrContext) {
      ...
      const location2 = isExternal2 ? toPath : joinURL((/* @__PURE__ */ useRuntimeConfig()).app.baseURL, fullPath);
...
const unhead_BpoVZOGVGk = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const __nuxt_page_meta$8 = { hiddenFooter: true };
...
const _routes = [
  {
    name: "ai_ppt-_components-gen-outline",
    path: "/ai_ppt/_components/gen-outline",
    component: () => import('./gen-outline-B0NhKtZ-.mjs').then((m) => m.default || m)
  },
  {
    name: "ai_ppt-_components-prompt-input",
    path: "/ai_ppt/_components/prompt-input",
    component: () => import('./prompt-input-ByM8SS0-.mjs').then((m) => m.default || m)
  },
  {
    name: "ai_ppt-_components-select-template",
    path: "/ai_ppt/_components/select-template",
    component: () => import('./select-template-CAU51dfS.mjs').then((m) => m.default || m)
  },
  {
    name: "ai_ppt-aiPPT",
    path: "/ai_ppt/aiPPT",
    component: () => import('./aiPPT-BfjAVP_f.mjs').then((m) => m.default || m)
  },
  {
    name: "ai_ppt-detail",
    path: "/ai_ppt/detail",
    meta: __nuxt_page_meta$B,
    component: () => import('./detail-BGt1ZVzw.mjs').then((m) => m.default || m)
  },
  {
    name: "ai_ppt-history",
    path: "/ai_ppt/history",
    meta: __nuxt_page_meta$A,
    component: () => import('./history-BrzO-1hA.mjs').then((m) => m.default || m)
  },
  {
    name: "ai_ppt",
    path: "/ai_ppt",
    meta: __nuxt_page_meta$z,
    component: () => import('./index-CvJZQN2m.mjs').then((m) => m.default || m)
  },
  {
    name: "app_center",
    path: "/app_center",
    meta: __nuxt_page_meta$y,
    component: () => import('./index-BaOKl9rb.mjs').then((m) => m.default || m)
  },
  {
    name: "application-chat",
    path: "/application/chat",
    meta: __nuxt_page_meta$x,
    component: () => import('./chat-Ce0ZuDL0.mjs').then((m) => m.default || m)
  },
  {
    name: "application-digital-_components-add",
    path: "/application/digital/_components/add",
    component: () => import('./add-2Mfhn0Pq.mjs').then((m) => m.default || m)
  },
  {
    name: "application-digital-edit",
    path: "/application/digital/edit",
    meta: __nuxt_page_meta$w,
    component: () => import('./edit-qXb869Ay.mjs').then((m) => m.default || m)
  },
  {
    name: "application-kb-_components-addPop",
    path: "/application/kb/_components/addPop",
    component: () => import('./addPop-CT4BzglM.mjs').then((m) => m.default || m)
  },
  {
    name: "application-kb-detail-_components-base-setting",
    path: "/application/kb/detail/_components/base-setting",
    component: () => import('./base-setting-BjubuKtS.mjs').then((m) => m.default || m)
  },
  {
    name: "application-kb-detail-_components-data-study",
    path: "/application/kb/detail/_components/data-study",
    component: () => import('./data-study-B5r1XT-g.mjs').then((m) => m.default || m)
  },
  {
    name: "application-kb-detail-_components-edit-qa",
    path: "/application/kb/detail/_components/edit-qa",
    component: () => import('./edit-qa-6KyixAaD.mjs').then((m) => m.default || m)
  },
  {
    name: "application-kb-detail-_components-import-cvs-data-item",
    path: "/application/kb/detail/_components/import/cvs-data-item",
    component: () => import('./cvs-data-item-N7r8ecjG.mjs').then((m) => m.default || m)
  },
  {
    name: "application-kb-detail-_components-import-cvs",
    path: "/application/kb/detail/_components/import/cvs",
    component: () => import('./cvs-C_N0Vrqd.mjs').then((m) => m.default || m)
  },
  {
    name: "application-kb-detail-_components-import-data-item",
    path: "/application/kb/detail/_components/import/data-item",
    component: () => import('./data-item-CQ7fNu3a.mjs').then((m) => m.default || m)
  },
  {
    name: "application-kb-detail-_components-import-doc",
    path: "/application/kb/detail/_components/import/doc",
    component: () => import('./doc-CFxCD4qQ.mjs').then((m) => m.default || m)
  },
  {
    name: "application-kb-detail-_components-import-hook",
    path: "/application/kb/detail/_components/import/hook",
    component: () => import('./hook-1nkmW8DG.mjs').then((m) => m.default || m)
  },
  {
    name: "application-kb-detail-_components-import-manual-doc",
    path: "/application/kb/detail/_components/import/manual-doc",
    component: () => import('./manual-doc-B5RWUlZJ.mjs').then((m) => m.default || m)
  },
  {
    name: "application-kb-detail-_components-import-manual",
    path: "/application/kb/detail/_components/import/manual",
    component: () => import('./manual-BntScZJB.mjs').then((m) => m.default || m)
  },
  {
    name: "application-kb-detail-_components-import-QASplit",
    path: "/application/kb/detail/_components/import/QASplit",
    component: () => import('./QASplit-BEI1cWI8.mjs').then((m) => m.default || m)
  },
  {
    name: "application-kb-detail-_components-import-web-page",
    path: "/application/kb/detail/_components/import/web-page",
    component: () => import('./web-page-BYRtriXd.mjs').then((m) => m.default || m)
  },
  {
    name: "application-kb-detail-_components-setUp",
    path: "/application/kb/detail/_components/setUp",
    component: () => import('./setUp-BT-vQyEh.mjs').then((m) => m.default || m)
  },
  {
    name: "application-kb-detail-_components-study_com-datalist",
    path: "/application/kb/detail/_components/study_com/datalist",
    component: () => import('./datalist-BecEn16X.mjs').then((m) => m.default || m)
  },
  {
    name: "application-kb-detail-_components-study_com-editPop",
    path: "/application/kb/detail/_components/study_com/editPop",
    component: () => import('./editPop-BfSBoyhz.mjs').then((m) => m.default || m)
  },
  {
    name: "application-kb-detail-_components-study_com-importData",
    path: "/application/kb/detail/_components/study_com/importData",
    component: () => import('./importData-Ba-cBYE9.mjs').then((m) => m.default || m)
  },
  {
    name: "application-kb-detail-_components-study_com-itemList",
    path: "/application/kb/detail/_components/study_com/itemList",
    component: () => import('./itemList-DL-7It9q.mjs').then((m) => m.default || m)
  },
  {
    name: "application-kb-detail-_components-study_com-renamePop",
    path: "/application/kb/detail/_components/study_com/renamePop",
    component: () => import('./renamePop-BToUb_Ck.mjs').then((m) => m.default || m)
  },
  {
    name: "application-kb-detail-_components-team-data-com-add-user",
    path: "/application/kb/detail/_components/team-data-com/add-user",
    component: () => import('./add-user-CGCYccD1.mjs').then((m) => m.default || m)
  },
  {
    name: "application-kb-detail-_components-team-data-com-permission-option",
    path: "/application/kb/detail/_components/team-data-com/permission-option",
    component: () => import('./permission-option-4Rq1I_93.mjs').then((m) => m.default || m)
  },
  {
    name: "application-kb-detail-_components-team-data",
    path: "/application/kb/detail/_components/team-data",
    component: () => import('./team-data-BjoFhsgf.mjs').then((m) => m.default || m)
  },
  {
    name: "application-kb-detail-_components-testData",
    path: "/application/kb/detail/_components/testData",
    component: () => import('./testData-BXS6tI4W.mjs').then((m) => m.default || m)
  },
  {
    name: "application-kb-detail",
    path: "/application/kb/detail",
    meta: __nuxt_page_meta$v,
    component: () => import('./index-DQctk9wT.mjs').then((m) => m.default || m)
  },
  {
    name: "application-layout",
    path: "/application/layout",
    meta: __nuxt_page_meta$r,
    component: () => import('./layout-Nwc20YZO.mjs').then((m) => m.default || m),
    children: [
      {
        name: "application-layout-_components-robot-share",
        path: "_components/robot-share",
        component: () => import('./robot-share-CHXRXlHd.mjs').then((m) => m.default || m)
      },
      {
        name: "application-layout-digital",
        path: "digital",
        meta: __nuxt_page_meta$u,
        component: () => import('./digital-P766VZRn.mjs').then((m) => m.default || m)
      },
      {
        name: "application-layout-kb",
        path: "kb",
        meta: __nuxt_page_meta$t,
        component: () => import('./kb-iWoqpmou.mjs').then((m) => m.default || m)
      },
      {
        name: "application-layout-robot",
        path: "robot",
        meta: __nuxt_page_meta$s,
        component: () => import('./robot-B5jbdbL1.mjs').then((m) => m.default || m)
      }
    ]
  },
  {
    name: "application-robot-_components-app-dialogue-correct-popup",
    path: "/application/robot/_components/app-dialogue/correct-popup",
    component: () => import('./correct-popup-W2_Kapug.mjs').then((m) => m.default || m)
  },
  {
    name: "application-robot-_components-app-dialogue-data",
    path: "/application/robot/_components/app-dialogue/data",
    component: () => import('./data-DABQECqE.mjs').then((m) => m.default || m)
  },
  {
    name: "application-robot-_components-app-dialogue",
    path: "/application/robot/_components/app-dialogue",
    component: () => import('./index-CDoCTF-s.mjs').then((m) => m.default || m)
  },
  {
    name: "application-robot-_components-app-dialogue-record",
    path: "/application/robot/_components/app-dialogue/record",
    component: () => import('./record-BAVzAhl8.mjs').then((m) => m.default || m)
  },
  {
    name: "application-robot-_components-app-dialogue-reply-popup",
    path: "/application/robot/_components/app-dialogue/reply-popup",
    component: () => import('./reply-popup-DA2FFVvQ.mjs').then((m) => m.default || m)
  },
  {
    name: "application-robot-_components-app-edit-add-menu",
    path: "/application/robot/_components/app-edit/add-menu",
    component: () => import('./add-menu-DbND_aK2.mjs').then((m) => m.default || m)
  },
  {
    name: "application-robot-_components-app-edit-base-config",
    path: "/application/robot/_components/app-edit/base-config",
    component: () => import('./base-config-D2JCcEJz.mjs').then((m) => m.default || m)
  },
  {
    name: "application-robot-_components-app-edit-digital-config",
    path: "/application/robot/_components/app-edit/digital-config",
    component: () => import('./digital-config-G1TuaWzp.mjs').then((m) => m.default || m)
  },
  {
    name: "application-robot-_components-app-edit",
    path: "/application/robot/_components/app-edit",
    component: () => import('./index-D0pNL-gw.mjs').then((m) => m.default || m)
  },
  {
    name: "application-robot-_components-app-edit-interface-config",
    path: "/application/robot/_components/app-edit/interface-config",
    component: () => import('./interface-config-BWIUWMLo.mjs').then((m) => m.default || m)
  },
  {
    name: "application-robot-_components-app-edit-search-config",
    path: "/application/robot/_components/app-edit/search-config",
    component: () => import('./search-config-CUeFuQKo.mjs').then((m) => m.default || m)
  },
  {
    name: "application-robot-_components-app-release-api",
    path: "/application/robot/_components/app-release/api",
    component: () => import('./api-DRonrYhJ.mjs').then((m) => m.default || m)
  },
  {
    name: "application-robot-_components-app-release-call-description",
    path: "/application/robot/_components/app-release/call-description",
    component: () => import('./call-description-Dq-CqIt6.mjs').then((m) => m.default || m)
  },
  {
    name: "application-robot-_components-app-release-create-api",
    path: "/application/robot/_components/app-release/create-api",
    component: () => import('./create-api-DSzwJdwa.mjs').then((m) => m.default || m)
  },
  {
    name: "application-robot-_components-app-release-create-share",
    path: "/application/robot/_components/app-release/create-share",
    component: () => import('./create-share-5dUrzWP0.mjs').then((m) => m.default || m)
  },
  {
    name: "application-robot-_components-app-release",
    path: "/application/robot/_components/app-release",
    component: () => import('./index-cBGHZYI5.mjs').then((m) => m.default || m)
  },
  {
    name: "application-robot-_components-app-release-js-embedding",
    path: "/application/robot/_components/app-release/js-embedding",
    component: () => import('./js-embedding-DqJ9JY5f.mjs').then((m) => m.default || m)
  },
  {
    name: "application-robot-_components-app-release-js",
    path: "/application/robot/_components/app-release/js",
    component: () => import('./js-baDvRtVH.mjs').then((m) => m.default || m)
  },
  {
    name: "application-robot-_components-app-release-oa-config",
    path: "/application/robot/_components/app-release/oa-config",
    component: () => import('./oa-config-C3zr4Tkt.mjs').then((m) => m.default || m)
  },
  {
    name: "application-robot-_components-app-release-oa",
    path: "/application/robot/_components/app-release/oa",
    component: () => import('./oa-BeyUFV1j.mjs').then((m) => m.default || m)
  },
  {
    name: "application-robot-_components-app-release-platform-select",
    path: "/application/robot/_components/app-release/platform-select",
    component: () => import('./platform-select-A4W7u-r9.mjs').then((m) => m.default || m)
  },
  {
    name: "application-robot-_components-app-release-poster",
    path: "/application/robot/_components/app-release/poster",
    component: () => import('./poster-5CDeCzu_.mjs').then((m) => m.default || m)
  },
  {
    name: "application-robot-_components-app-release-usage-settings",
    path: "/application/robot/_components/app-release/usage-settings",
    component: () => import('./usage-settings-D9Rk2FPz.mjs').then((m) => m.default || m)
  },
  {
    name: "application-robot-_components-app-release-web",
    path: "/application/robot/_components/app-release/web",
    component: () => import('./web-Cqs2L09F.mjs').then((m) => m.default || m)
  },
  {
    name: "application-robot-setting",
    path: "/application/robot/setting",
    meta: __nuxt_page_meta$q,
    component: () => import('./setting-DMwfM-jV.mjs').then((m) => m.default || m)
  },
  {
    name: "chat-_components-login",
    path: "/chat/_components/login",
    component: () => import('./login-SAVrBZnH.mjs').then((m) => m.default || m)
  },
  {
    name: "chat-key",
    path: "/chat/:key()",
    meta: __nuxt_page_meta$p,
    component: () => import('./_key_-BX4G7yQL.mjs').then((m) => m.default || m)
  },
  {
    name: "creation-_components-create-panel",
    path: "/creation/_components/create-panel",
    component: () => import('./create-panel-DOW-5Uek.mjs').then((m) => m.default || m)
  },
  {
    name: "creation-_components-create-results",
    path: "/creation/_components/create-results",
    component: () => import('./create-results-93a7QIa8.mjs').then((m) => m.default || m)
  },
  {
    name: "creation-_components-model-select",
    path: "/creation/_components/model-select",
    component: () => import('./model-select-DDD5seYr.mjs').then((m) => m.default || m)
  },
  {
    name: "creation",
    path: "/creation",
    meta: __nuxt_page_meta$o,
    component: () => import('./index-BFP9D7M5.mjs').then((m) => m.default || m)
  },
  {
    name: "creation-produce",
    path: "/creation/produce",
    meta: __nuxt_page_meta$n,
    component: () => import('./produce-CvWsLxIf.mjs').then((m) => m.default || m)
  },
  {
    name: "dialogue-_components-role-sidebar",
    path: "/dialogue/_components/role-sidebar",
    component: () => import('./role-sidebar-F3uWRt8C.mjs').then((m) => m.default || m)
  },
  {
    name: "dialogue-_components-sample-lists",
    path: "/dialogue/_components/sample-lists",
    component: () => import('./sample-lists-DYEJfgLd.mjs').then((m) => m.default || m)
  },
  {
    name: "dialogue-chat",
    path: "/dialogue/chat",
    meta: __nuxt_page_meta$m,
    component: () => import('./chat-CctXbKwn.mjs').then((m) => m.default || m)
  },
  {
    name: "dialogue-role",
    path: "/dialogue/role",
    meta: __nuxt_page_meta$l,
    component: () => import('./role-1O_V1kqR.mjs').then((m) => m.default || m)
  },
  {
    name: "digital_human-_components-design-center-canvas-display",
    path: "/digital_human/_components/design-center/canvas-display",
    component: () => import('./canvas-display-CTT-1p6j.mjs').then((m) => m.default || m)
  },
  {
    name: "digital_human-_components-design-center-center-setting",
    path: "/digital_human/_components/design-center/center-setting",
    component: () => import('./center-setting-DPq2Wa2F.mjs').then((m) => m.default || m)
  },
  {
    name: "digital_human-_components-design-center-center-top",
    path: "/digital_human/_components/design-center/center-top",
    component: () => import('./center-top-C9U-ZCT8.mjs').then((m) => m.default || m)
  },
  {
    name: "digital_human-_components-design-center",
    path: "/digital_human/_components/design-center",
    component: () => import('./index-k70exgaE.mjs').then((m) => m.default || m)
  },
  {
    name: "digital_human-_components-design-center-select-dub",
    path: "/digital_human/_components/design-center/select-dub",
    component: () => import('./select-dub-5jeBvqY_.mjs').then((m) => m.default || m)
  },
  {
    name: "digital_human-_components-design-center-select-music",
    path: "/digital_human/_components/design-center/select-music",
    component: () => import('./select-music-BQ-v2cow.mjs').then((m) => m.default || m)
  },
  {
    name: "digital_human-_components-design-center-select-size",
    path: "/digital_human/_components/design-center/select-size",
    component: () => import('./select-size-Dm-nKB7i.mjs').then((m) => m.default || m)
  },
  {
    name: "digital_human-_components-design-header",
    path: "/digital_human/_components/design-header",
    component: () => import('./design-header-C9kMdMsr.mjs').then((m) => m.default || m)
  },
  {
    name: "digital_human-_components-design-left-avatar",
    path: "/digital_human/_components/design-left/avatar",
    component: () => import('./avatar-Da-ItgaI.mjs').then((m) => m.default || m)
  },
  {
    name: "digital_human-_components-design-left-background",
    path: "/digital_human/_components/design-left/background",
    component: () => import('./background-BY4MFQMz.mjs').then((m) => m.default || m)
  },
  {
    name: "digital_human-_components-design-left-captions",
    path: "/digital_human/_components/design-left/captions",
    component: () => import('./captions-DU0Kvo3l.mjs').then((m) => m.default || m)
  },
  {
    name: "digital_human-_components-design-left-dub-item",
    path: "/digital_human/_components/design-left/dub-item",
    component: () => import('./dub-item-QlRowzhf.mjs').then((m) => m.default || m)
  },
  {
    name: "digital_human-_components-design-left-dub",
    path: "/digital_human/_components/design-left/dub",
    component: () => import('./dub-1uaxlrpt.mjs').then((m) => m.default || m)
  },
  {
    name: "digital_human-_components-design-left-effect-list",
    path: "/digital_human/_components/design-left/effect-list",
    component: () => import('./effect-list-DJPn3tRr.mjs').then((m) => m.default || m)
  },
  {
    name: "digital_human-_components-design-left",
    path: "/digital_human/_components/design-left",
    component: () => import('./index-Du6whSPQ.mjs').then((m) => m.default || m)
  },
  {
    name: "digital_human-_components-design-left-maps",
    path: "/digital_human/_components/design-left/maps",
    component: () => import('./maps-KaeC0uWT.mjs').then((m) => m.default || m)
  },
  {
    name: "digital_human-_components-design-left-music",
    path: "/digital_human/_components/design-left/music",
    component: () => import('./music-B1eYyUpS.mjs').then((m) => m.default || m)
  },
  {
    name: "digital_human-_components-design-left-prospect",
    path: "/digital_human/_components/design-left/prospect",
    component: () => import('./prospect-CAocfG1u.mjs').then((m) => m.default || m)
  },
  {
    name: "digital_human-_components-design-left-text-setting",
    path: "/digital_human/_components/design-left/text-setting",
    component: () => import('./text-setting-XtZUo9Gm.mjs').then((m) => m.default || m)
  },
  {
    name: "digital_human-_components-design-left-text",
    path: "/digital_human/_components/design-left/text",
    component: () => import('./text-nrtwaws2.mjs').then((m) => m.default || m)
  },
  {
    name: "digital_human-_components-design-right",
    path: "/digital_human/_components/design-right",
    component: () => import('./index-Dxej-YBv.mjs').then((m) => m.default || m)
  },
  {
    name: "digital_human-aside",
    path: "/digital_human/aside",
    meta: __nuxt_page_meta$j,
    component: () => import('./aside-C0DJanEh.mjs').then((m) => m.default || m),
    children: [
      {
        name: "digital_human-aside-video_compositing",
        path: "video_compositing",
        meta: __nuxt_page_meta$k,
        component: () => import('./video_compositing-Empy4Fed.mjs').then((m) => m.default || m)
      }
    ]
  },
  {
    name: "digital_human-design",
    path: "/digital_human/design",
    meta: __nuxt_page_meta$i,
    component: () => import('./design-BTrjop2V.mjs').then((m) => m.default || m)
  },
  {
    name: "digital_human",
    path: "/digital_human",
    component: () => import('./index-CrUnp2lA.mjs').then((m) => m.default || m)
  },
  {
    name: "digital-chat",
    path: "/digital/chat",
    meta: __nuxt_page_meta$h,
    component: () => import('./chat-DrUfvPsP.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-components-common-create-button",
    path: "/draw/components/common/create-button",
    component: () => import('./create-button-am2dhDog.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-components-common-draw-api",
    path: "/draw/components/common/draw-api",
    component: () => import('./draw-api-DSkgdynF.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-components-common-draw-result",
    path: "/draw/components/common/draw-result",
    component: () => import('./draw-result-3pgZiKX4.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-components-common-draw-share",
    path: "/draw/components/common/draw-share",
    component: () => import('./draw-share-CqwfKs_W.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-components-common-draw-type",
    path: "/draw/components/common/draw-type",
    component: () => import('./draw-type-CEvfMGVO.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-components-common-negative-prompt",
    path: "/draw/components/common/negative-prompt",
    component: () => import('./negative-prompt-Cw1F_Z1A.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-components-common-prompt-selector",
    path: "/draw/components/common/prompt-selector",
    component: () => import('./prompt-selector-DeTNndAA.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-components-common-prompt",
    path: "/draw/components/common/prompt",
    component: () => import('./prompt-RZrNgRXL.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-components-common-sidbar-item-title",
    path: "/draw/components/common/sidbar-item-title",
    component: () => import('./sidbar-item-title-aTPs1IEb.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-components-common-uploader",
    path: "/draw/components/common/uploader",
    component: () => import('./uploader-B-bowUcG.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-components-dalle-dalle-picture-quality",
    path: "/draw/components/dalle/dalle-picture-quality",
    component: () => import('./dalle-picture-quality-Bl6CLM83.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-components-dalle-dalle-picture-size",
    path: "/draw/components/dalle/dalle-picture-size",
    component: () => import('./dalle-picture-size-CZe1GXmY.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-components-dalle-dalle-style-picker",
    path: "/draw/components/dalle/dalle-style-picker",
    component: () => import('./dalle-style-picker-Dadmq0Mr.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-components-doubao-doubao-model",
    path: "/draw/components/doubao/doubao-model",
    component: () => import('./doubao-model-BYIMt1OA.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-components-doubao-doubao-options",
    path: "/draw/components/doubao/doubao-options",
    component: () => import('./doubao-options-D4rSEKoQ.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-components-doubao-doubao-picture-size",
    path: "/draw/components/doubao/doubao-picture-size",
    component: () => import('./doubao-picture-size-BzVdM8QE.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-components-mj-image-editor",
    path: "/draw/components/mj/image-editor",
    component: () => import('./image-editor-CXRfZ5rL.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-components-mj-mj-model",
    path: "/draw/components/mj/mj-model",
    component: () => import('./mj-model-C9h7c3LH.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-components-mj-mj-options",
    path: "/draw/components/mj/mj-options",
    component: () => import('./mj-options-C-ag_XMA.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-components-mj-mj-picture-size",
    path: "/draw/components/mj/mj-picture-size",
    component: () => import('./mj-picture-size-7bpK60oL.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-components-mj-mj-styles",
    path: "/draw/components/mj/mj-styles",
    component: () => import('./mj-styles-D5XFMTWl.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-components-mj-mj-version",
    path: "/draw/components/mj/mj-version",
    component: () => import('./mj-version-CBEMCIGd.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-components-sd-sd-denoising-strength",
    path: "/draw/components/sd/sd-denoising-strength",
    component: () => import('./sd-denoising-strength-VTha4mrF.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-components-sd-sd-lora",
    path: "/draw/components/sd/sd-lora",
    component: () => import('./sd-lora-Df-FFoS9.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-components-sd-sd-model",
    path: "/draw/components/sd/sd-model",
    component: () => import('./sd-model-CfCejklr.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-components-sd-sd-options",
    path: "/draw/components/sd/sd-options",
    component: () => import('./sd-options-DL2A5rJW.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-components-sd-sd-picture-size",
    path: "/draw/components/sd/sd-picture-size",
    component: () => import('./sd-picture-size-BJObFq1w.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-dalle",
    path: "/draw/dalle",
    meta: __nuxt_page_meta$g,
    component: () => import('./dalle-Dbr0VqIo.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-doubao",
    path: "/draw/doubao",
    meta: __nuxt_page_meta$f,
    component: () => import('./doubao-BDPlP3g-.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-enums-DrawEnum",
    path: "/draw/enums/DrawEnum",
    component: () => import('./DrawEnum-CqAPEJOR.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-hooks-DrawingTool",
    path: "/draw/hooks/DrawingTool",
    component: () => import('./DrawingTool-DEHEFSZT.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-hooks-useDrawEffect",
    path: "/draw/hooks/useDrawEffect",
    component: () => import('./useDrawEffect-B2jxDCVi.mjs').then(function(n) {
      return n.u;
    }).then((m) => m.default || m)
  },
  {
    name: "draw-hooks-useImageEditor",
    path: "/draw/hooks/useImageEditor",
    component: () => import('./useImageEditor-FUvZEPjo.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-hooks-useImageSplit",
    path: "/draw/hooks/useImageSplit",
    component: () => import('./useImageSplit-WhIb7DvG.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-mj",
    path: "/draw/mj",
    meta: __nuxt_page_meta$e,
    component: () => import('./mj-CCQ9cu_z.mjs').then((m) => m.default || m)
  },
  {
    name: "draw-sd",
    path: "/draw/sd",
    meta: __nuxt_page_meta$d,
    component: () => import('./sd-D0wPMALr.mjs').then((m) => m.default || m)
  },
  {
    name: "empty",
    path: "/empty",
    meta: __nuxt_page_meta$c,
    component: () => import('./index-ChZP1qnR.mjs').then((m) => m.default || m)
  },
  {
    name: "index-_components-entrance",
    path: "//_components/entrance",
    component: () => import('./entrance-D67OpvrX.mjs').then(function(n) {
      return n._;
    }).then((m) => m.default || m)
  },
  {
    name: "index-_components-guide",
    path: "//_components/guide",
    component: () => import('./guide-CT2_xTNK.mjs').then(function(n) {
      return n._;
    }).then((m) => m.default || m)
  },
  {
    name: "index-_components-header",
    path: "//_components/header",
    component: () => import('./header-BSZGZ8i5.mjs').then(function(n) {
      return n._;
    }).then((m) => m.default || m)
  },
  {
    name: "index-_components",
    path: "//_components",
    component: () => import('./index-BKCm5SrI.mjs').then((m) => m.default || m)
  },
  {
    name: "index-_components-intro",
    path: "//_components/intro",
    component: () => import('./intro-BJNU7tT2.mjs').then(function(n) {
      return n._;
    }).then((m) => m.default || m)
  },
  {
    name: "index-_components-title",
    path: "//_components/title",
    component: () => import('./title-5oqj6kGf.mjs').then(function(n) {
      return n._;
    }).then((m) => m.default || m)
  },
  {
    ...
    path: "/",
    meta: __nuxt_page_meta$b,
    component: () => import('./index-CxoIJBIc.mjs').then((m) => m.default || m)
  },
  {
    name: "mind_map-component-control-panel",
    path: "/mind_map/component/control-panel",
    component: () => import('./control-panel-CGiAGGdB.mjs').then((m) => m.default || m)
  },
  {
    name: "mind_map-component-empty-view",
    path: "/mind_map/component/empty-view",
    component: () => import('./empty-view-Cba0x6k2.mjs').then((m) => m.default || m)
  },
  {
    name: "mind_map-component-history-all",
    path: "/mind_map/component/history-all",
    component: () => import('./history-all-Df7EuK7v.mjs').then((m) => m.default || m)
  },
  {
    name: "mind_map-component-history",
    path: "/mind_map/component/history",
    component: () => import('./history-CM47AKko.mjs').then((m) => m.default || m)
  },
  {
    name: "mind_map-component-mind-map-preview",
    path: "/mind_map/component/mind-map-preview",
    component: () => import('./mind-map-preview-J5CqpYbM.mjs').then((m) => m.default || m)
  },
  {
    name: "mind_map",
    path: "/mind_map",
    meta: __nuxt_page_meta$a,
    component: () => import('./index-CWM43koi.mjs').then((m) => m.default || m)
  },
  {
    name: "music-_components-form",
    path: "/music/_components/form",
    component: () => import('./index-BorsA2eH.mjs').then((m) => m.default || m)
  },
  {
    name: "music-_components-record",
    path: "/music/_components/record",
    component: () => import('./index-BlG_FY-O.mjs').then((m) => m.default || m)
  },
  {
    name: "music",
    path: "/music",
    meta: __nuxt_page_meta$9,
    component: () => import('./index-70MRwVU5.mjs').then((m) => m.default || m)
  },
  {
    name: "music-player",
    path: "/music/player",
    meta: __nuxt_page_meta$8,
    component: () => import('./player-BwcU8PME.mjs').then((m) => m.default || m)
  },
  {
    name: "policy-type",
    path: "/policy/:type()",
    meta: __nuxt_page_meta$7,
    component: () => import('./_type_-DbLzak6s.mjs').then((m) => m.default || m)
  },
  {
    name: "recharge-_components-recharge",
    path: "/recharge/_components/recharge",
    component: () => import('./recharge-CPxsnpho.mjs').then((m) => m.default || m)
  },
  {
    name: "recharge",
    path: "/recharge",
    meta: __nuxt_page_meta$6,
    component: () => import('./index-DvAtHuR1.mjs').then((m) => m.default || m)
  },
  {
    name: "robot_square-_components-draw",
    path: "/robot_square/_components/draw",
    component: () => import('./draw-COlDgzMm.mjs').then((m) => m.default || m)
  },
  {
    name: "robot_square-_components-music",
    path: "/robot_square/_components/music",
    component: () => import('./music-Cg_-zxEJ.mjs').then((m) => m.default || m)
  },
  {
    name: "robot_square-_components-posterPop",
    path: "/robot_square/_components/posterPop",
    component: () => import('./posterPop-CHjpMb7r.mjs').then((m) => m.default || m)
  },
  {
    name: "robot_square-_components-robot",
    path: "/robot_square/_components/robot",
    component: () => import('./robot-DgxANSf5.mjs').then((m) => m.default || m)
  },
  {
    name: "robot_square-_components-video",
    path: "/robot_square/_components/video",
    component: () => import('./video-BXOGaQI6.mjs').then((m) => m.default || m)
  },
  {
    name: "robot_square-chat",
    path: "/robot_square/chat",
    meta: __nuxt_page_meta$5,
    component: () => import('./chat-DwiBx6R1.mjs').then((m) => m.default || m)
  },
  {
    name: "robot_square",
    path: "/robot_square",
    meta: __nuxt_page_meta$4,
    component: () => import('./index-B6lOLsh6.mjs').then((m) => m.default || m)
  },
  {
    name: "search-_components-common-collapse",
    path: "/search/_components/common/collapse",
    component: () => import('./collapse-Dkv7cdT3.mjs').then((m) => m.default || m)
  },
  {
    name: "search-_components-common-search-btn",
    path: "/search/_components/common/search-btn",
    component: () => import('./search-btn-Bu4r_Ca5.mjs').then((m) => m.default || m)
  },
  {
    name: "search-_components-common-search-ex",
    path: "/search/_components/common/search-ex",
    component: () => import('./search-ex-US3m0iO4.mjs').then((m) => m.default || m)
  },
  {
    name: "search-_components-common-search-input",
    path: "/search/_components/common/search-input",
    component: () => import('./search-input-CX9i7r_c.mjs').then((m) => m.default || m)
  },
  {
    name: "search-_components-common-search-model",
    path: "/search/_components/common/search-model",
    component: () => import('./search-model-BZBVjp2U.mjs').then((m) => m.default || m)
  },
  {
    name: "search-_components-common-search-type",
    path: "/search/_components/common/search-type",
    component: () => import('./search-type-BDTcaOnm.mjs').then((m) => m.default || m)
  },
  {
    name: "search-_components-search-ask",
    path: "/search/_components/search-ask",
    component: () => import('./search-ask-BpCHqknd.mjs').then((m) => m.default || m)
  },
  {
    name: "search-_components-search-history",
    path: "/search/_components/search-history",
    component: () => import('./search-history-GHzkDnnk.mjs').then((m) => m.default || m)
  },
  {
    name: "search-_components-search-result-action-btns",
    path: "/search/_components/search-result/action-btns",
    component: () => import('./action-btns-BACVGK4l.mjs').then((m) => m.default || m)
  },
  {
    name: "search-_components-search-result-doc",
    path: "/search/_components/search-result/doc",
    component: () => import('./doc-DoNecCCG.mjs').then((m) => m.default || m)
  },
  {
    name: "search-_components-search-result",
    path: "/search/_components/search-result",
    component: () => import('./index-CVw00ac5.mjs').then((m) => m.default || m)
  },
  {
    name: "search-_components-search-result-input-select",
    path: "/search/_components/search-result/input-select",
    component: () => import('./input-select-BWZY0ed0.mjs').then((m) => m.default || m)
  },
  {
    name: "search-_components-search-result-mind-map",
    path: "/search/_components/search-result/mind-map",
    component: () => import('./mind-map-LCO32sbi.mjs').then((m) => m.default || m)
  },
  {
    name: "search-_components-search-result-outline",
    path: "/search/_components/search-result/outline",
    component: () => import('./outline-9dEanu7b.mjs').then((m) => m.default || m)
  },
  {
    name: "search-_components-search-result-steps",
    path: "/search/_components/search-result/steps",
    component: () => import('./steps-CVh2uKQ2.mjs').then((m) => m.default || m)
  },
  {
    name: "search-_components-search-result-suggestion",
    path: "/search/_components/search-result/suggestion",
    component: () => import('./suggestion-DUZ5Re6M.mjs').then((m) => m.default || m)
  },
  {
    name: "search",
    path: "/search",
    meta: __nuxt_page_meta$3,
    component: () => import('./index-C54QWR9n.mjs').then((m) => m.default || m)
  },
  {
    name: "search-searchEnums",
    path: "/search/searchEnums",
    component: () => import('./searchEnums-Dgcx5RT8.mjs').then((m) => m.default || m)
  },
  {
    name: "search-useSearch",
    path: "/search/useSearch",
    component: () => import('./useSearch-BaJoxou4.mjs').then((m) => m.default || m)
  },
  {
    name: "user-_components-sidePop",
    path: "/user/_components/sidePop",
    component: () => import('./sidePop-DC0e2WFv.mjs').then((m) => m.default || m)
  },
  {
    name: "user",
    path: "/user",
    meta: __nuxt_page_meta$1,
    component: () => import('./index-DAU6YS3K.mjs').then((m) => m.default || m),
    children: [
      {
        name: "user-index-_components-bindmobilePop",
        path: "_components/bindmobilePop",
        component: () => import('./bindmobilePop-Dz6IQIMA.mjs').then((m) => m.default || m)
      },
      {
        name: "user-index-_components-changePwdPop",
        path: "_components/changePwdPop",
        component: () => import('./changePwdPop-CA-FyOAp.mjs').then((m) => m.default || m)
      },
      {
        name: "user-index-_components-recordDetailPop",
        path: "_components/recordDetailPop",
        component: () => import('./recordDetailPop-CAIQlTnD.mjs').then((m) => m.default || m)
      },
      {
        name: "user-index-balance",
        path: "balance",
        component: () => import('./balance-CfZgSZzD.mjs').then((m) => m.default || m)
      },
      {
        name: "user-index-center",
        path: "center",
        component: () => import('./center-qz_Wl_s7.mjs').then((m) => m.default || m)
      },
      {
        name: "user-index-member",
        path: "member",
        component: () => import('./member-CVcbNpC6.mjs').then((m) => m.default || m)
      },
      {
        name: "user-index-notification",
        path: "notification",
        component: () => import('./notification--de8Zg5K.mjs').then((m) => m.default || m)
      },
      {
        name: "user-index-promotion-_components-apply",
        path: "promotion/_components/apply",
        component: () => import('./apply-CXBsbW7R.mjs').then((m) => m.default || m)
      },
      {
        name: "user-index-promotion-_components-income-detail",
        path: "promotion/_components/income-detail",
        component: () => import('./income-detail-rOlQLrv4.mjs').then((m) => m.default || m)
      },
      {
        name: "user-index-promotion-_components-poster",
        path: "promotion/_components/poster",
        component: () => import('./poster-tSZTZBf8.mjs').then((m) => m.default || m)
      },
      {
        name: "user-index-promotion-_components-withdraw-apply",
        path: "promotion/_components/withdraw/apply",
        component: () => import('./apply-BxZl1gZW.mjs').then((m) => m.default || m)
      },
      {
        name: "user-index-promotion-_components-withdraw-detail",
        path: "promotion/_components/withdraw/detail",
        component: () => import('./detail-DN39nOVW.mjs').then((m) => m.default || m)
      },
      {
        name: "user-index-promotion-_components-withdraw-record",
        path: "promotion/_components/withdraw/record",
        component: () => import('./record-BkhBQb3M.mjs').then((m) => m.default || m)
      },
      {
        name: "user-index-promotion-distribution",
        path: "promotion/distribution",
        component: () => import('./distribution-DZ_bH2-W.mjs').then((m) => m.default || m)
      },
      {
        name: "user-index-recharge",
        path: "recharge",
        component: () => import('./recharge-NT6zxiEg.mjs').then((m) => m.default || m)
      },
      {
        name: "user-index-record-_components-member",
        path: "record/_components/member",
        component: () => import('./member-DNTAnuxW.mjs').then((m) => m.default || m)
      },
      {
        name: "user-index-record-_components-recharge",
        path: "record/_components/recharge",
        component: () => import('./recharge-Ce0giH5-.mjs').then((m) => m.default || m)
      },
      {
        name: "user-index-record",
        path: "record",
        component: () => import('./index-CB12kY5N.mjs').then((m) => m.default || m)
      },
      {
        name: "user-index-task_reward",
        path: "task_reward",
        component: () => import('./task_reward-Dpq1y-vn.mjs').then((m) => m.default || m)
      },
      {
        name: "user-index-works-_components-draw",
        path: "works/_components/draw",
        meta: __nuxt_page_meta$2,
        component: () => import('./draw-Bfy5dBBt.mjs').then((m) => m.default || m)
      },
      {
        name: "user-index-works-_components-image-preview",
        path: "works/_components/image-preview",
        component: () => import('./image-preview-DnIAxevr.mjs').then((m) => m.default || m)
      },
      {
        name: "user-index-works-_components-music",
        path: "works/_components/music",
        component: () => import('./music-oQw9Va3P.mjs').then((m) => m.default || m)
      },
      {
        name: "user-index-works-_components-video",
        path: "works/_components/video",
        component: () => import('./video-3CsxhFdg.mjs').then((m) => m.default || m)
      },
      {
        name: "user-index-works",
        path: "works",
        component: () => import('./index-BCQIXoS-.mjs').then((m) => m.default || m)
      }
    ]
  },
  {
    name: "video-_components-prompt",
    path: "/video/_components/prompt",
    component: () => import('./prompt-DBQuSt40.mjs').then((m) => m.default || m)
  },
  {
    name: "video-_components-uploader-picture",
    path: "/video/_components/uploader-picture",
    component: () => import('./uploader-picture-BEoMd7qV.mjs').then((m) => m.default || m)
  },
  {
    name: "video-_components-video-result",
    path: "/video/_components/video-result",
    component: () => import('./video-result-PLYZQFsO.mjs').then((m) => m.default || m)
  },
  {
    name: "video-_components-video-share",
    path: "/video/_components/video-share",
    component: () => import('./video-share-BGIVzO_L.mjs').then((m) => m.default || m)
  },
  {
    name: "video-_components-video-size",
    path: "/video/_components/video-size",
    component: () => import('./video-size-7uLk9r-T.mjs').then((m) => m.default || m)
  },
  {
    name: "video-_components-video-style",
    path: "/video/_components/video-style",
    component: () => import('./video-style-BtV9ixxb.mjs').then((m) => m.default || m)
  },
  {
    name: "video-_components-video-type",
    path: "/video/_components/video-type",
    component: () => import('./video-type-Ch-m1w_A.mjs').then((m) => m.default || m)
  },
  {
    name: "video",
    path: "/video",
    meta: __nuxt_page_meta,
    component: () => import('./index-BZRAoxp-.mjs').then((m) => m.default || m)
  }
];
...
var ScreenEnum = /* @__PURE__ */ ((ScreenEnum2) => {
  ...
  ScreenEnum2[ScreenEnum2["LG"] = 1024] = "LG";
  ScreenEnum2[ScreenEnum2["XL"] = 1280] = "XL";
  ScreenEnum2[ScreenEnum2["2XL"] = 1536] = "2XL";
  return ScreenEnum2;
})(ScreenEnum || {});
var SMSEnum = /* @__PURE__ */ ((SMSEnum2) => {
  SMSEnum2["LOGIN"] = "YZMDL";
  SMSEnum2["BIND_MOBILE"] = "BDSJHM";
  SMSEnum2["CHANGE_MOBILE"] = "BGSJHM";
  SMSEnum2["FIND_PASSWORD"] = "ZHDLMM";
  SMSEnum2["REGISTER"] = "YZMZC";
  return SMSEnum2;
})(SMSEnum || {});
var PolicyAgreementEnum = /* @__PURE__ */ ((PolicyAgreementEnum2) => {
  ...
  PolicyAgreementEnum2["PAY"] = "payment";
  PolicyAgreementEnum2["DISTRIBUTION"] = "distribution";
  return PolicyAgreementEnum2;
})(PolicyAgreementEnum || {});
var LoginPopupTypeEnum = /* @__PURE__ */ ((LoginPopupTypeEnum2) => {
  LoginPopupTypeEnum2[LoginPopupTypeEnum2["LOGIN"] = 0] = "LOGIN";
  LoginPopupTypeEnum2[LoginPopupTypeEnum2["FORGOT_PWD_MOBILE"] = 1] = "FORGOT_PWD_MOBILE";
  LoginPopupTypeEnum2[LoginPopupTypeEnum2["FORGOT_PWD_MAILBOX"] = 2] = "FORGOT_PWD_MAILBOX";
  LoginPopupTypeEnum2[LoginPopupTypeEnum2["REGISTER"] = 3] = "REGISTER";
  LoginPopupTypeEnum2[LoginPopupTypeEnum2["BIND_MOBILE"] = 4] = "BIND_MOBILE";
  LoginPopupTypeEnum2[LoginPopupTypeEnum2["BIND_WEIXIN"] = 5] = "BIND_WEIXIN";
  return LoginPopupTypeEnum2;
})(LoginPopupTypeEnum || {});
var ClientEnum = /* @__PURE__ */ ((ClientEnum2) => {
  ClientEnum2[ClientEnum2["WEIXIN_OA"] = 2] = "WEIXIN_OA";
  ClientEnum2[ClientEnum2["H5"] = 3] = "H5";
  ClientEnum2[ClientEnum2["PC"] = 4] = "PC";
  return ClientEnum2;
})(ClientEnum || {});
var ShareSquareEnum = /* @__PURE__ */ ((ShareSquareEnum2) => {
  ShareSquareEnum2[ShareSquareEnum2["DRAW"] = 1] = "DRAW";
  ShareSquareEnum2[ShareSquareEnum2["MUSIC"] = 2] = "MUSIC";
  ShareSquareEnum2[ShareSquareEnum2["VIDEO"] = 3] = "VIDEO";
  return ShareSquareEnum2;
})(ShareSquareEnum || {});
const isWeixinClient = () => {
  return /MicroMessenger/i.test((void 0).userAgent);
};
const getClient = () => {
  if (isMobile) {
    if (isWeixinClient()) {
...
const handleClientCallback = (callbacks) => {
  const c = ClientEnum[client];
  const callback = callbacks[c] || function() {
  };
  return callback();
};
...
function uploadFile(type, params) {
...
function getMusicCategory(params) {
  return $request.get({
...
function getBgCategory(params) {
  return $request.get({
    url: "/digital.material/backgroundCategory",
    params
  });
}
function getBgList(params) {
  return $request.get({
    url: "/digital.material/backgroundList",
    params
  });
}
function getMapsList(params) {
  return $request.get({
    url: "/digital.material/decalsList",
    params
  });
}
function getProspectsList(params) {
  return $request.get({
    url: "/digital.material/prepositionList",
    params
  });
}
function getDubList(params) {
  return $request.get({
    url: "/digital.material/auditList",
    params
  });
}
function getEffectList(params) {
  return $request.get({
    url: "/digital.material/effectList",
    params
  });
}
function getFontsList(params) {
  return $request.get({
    url: "/digital.material/fontsList",
    params
  });
}
function getVideoRecordsList(params) {
  return $request.get({
    url: "/video_records/lists",
    params
  });
}
function delVideoRecord(params) {
  return $request.post({
    url: "/video_records/del",
    params
  });
}
function putVideoRename(params) {
  return $request.post({
    url: "/video_records/rename",
    params
  });
}
function putAvatarSava(params) {
  return $request.post({
    url: "/digital.material/save",
    params
  });
}
function checkVideoStatus(params) {
  return $request.get({
    url: "/video_records/checkStatus",
    params
  });
}
function getAvatarDetail(params) {
  return $request.get({
    url: "/digital.material/detail",
    params
  });
}
const useAppStore = /* @__PURE__ */ defineStore({
  id: "appStore",
  state: () => ({
    config: {},
    isMobile: true,
  ...
  getters: {
    ...
    getIsShowRecharge: (state) => {
      var _a2;
      return ((_a2 = state.config.switch) == null ? void 0 : _a2.recharge_status) || false;
    },
    getIsShowMember: (state) => {
      var _a2;
      return ((_a2 = state.config) == null ? void 0 : _a2.member_package_open) || false;
    },
    getBulletinConfig: (state) => state.config.bulletin || {},
    getPcStatus: (state) => {
      var _a2;
      return ((_a2 = state.config.switch) == null ? void 0 : _a2.pc_status) || false;
    },
    getAccountCancelledStatus: (state) => {
      var _a2;
      return ((_a2 = state.config.switch) == null ? void 0 : _a2.account_cancelled) || false;
    },
    getIsVoiceOpen: (state) => {
      var _a2;
      return !!((_a2 = state.config.switch) == null ? void 0 : _a2.voice_status) || false;
    },
    getHeaderConfig: (state) => {
      var _a2;
      return ((_a2 = state.pageIndex.find((item) => item.name == "header")) == null ? void 0 : _a2.prop) || {};
    },
    ...
    getTokenUnit: (state) => {
      var _a2;
      return ((_a2 = state.config.chat) == null ? void 0 : _a2.price_unit) || "电力值";
    },
...
function uniqueId(len = 32, radix = 64) {
...
const useUserStore = /* @__PURE__ */ defineStore({
  ...
  actions: {
    ...
    //弹起登录二维码
    toggleShowLogin(toggle) {
      this.showLogin = toggle ?? !this.showLogin;
    },
    //弹起开通vip
    toggleShowRecharge(toggle) {
    ...
    setLoginPopupType(type = LoginPopupTypeEnum.LOGIN) {
    ...
    login(token) {
      const oneYear = 360 * 24 * 60 * 60 * 1e3;
      const TOKEN = useCookie(TOKEN_KEY, {
...
const init_45global = /* @__PURE__ */ defineNuxtRouteMiddleware(async (to, from) => {
  let __temp, __restore;
...
const version = "4.2.1";
const baseUrl = `${"https://php-cw.yixiangonline.com"}`;
const urlPrefix = "/api";
...
const wechatoa = {
  ...
  miniProgram: (_a = wx) == null ? void 0 : _a.miniProgram,
  ready() {
    return new Promise((resolve, reject) => {
      wx.ready(() => {
        resolve();
...
const plugin$1 = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(nuxtApp) {
    ...
    router.afterEach((to, from) => {
      var _a3, _b2, _c2, _d2;
      if (((_b2 = (_a3 = to.matched[0]) == null ? void 0 : _a3.components) == null ? void 0 : _b2.default) === ((_d2 = (_c2 = from.matched[0]) == null ? void 0 : _c2.components) == null ? void 0 : _d2.default)) {
        syncCurrentRoute();
      }
    });
    const route = {};
...
const revive_payload_server_JAenfqojem = /* @__PURE__ */ defineNuxtPlugin({
...
const getStyle = (element, styleName) => {
  ...
  try {
    ...
    if (style)
      return style;
    const computed2 = (_a2 = (void 0).defaultView) == null ? void 0 : _a2.getComputedStyle(element, "");
    return computed2 ? computed2[key] : "";
  } catch (e) {
    return element.style[key];
  }
};
function addUnit$1(value, defaultUnit = "px") {
  if (!value)
    return "";
...
const ElementPlusIcons = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  ...
  setup(__props) {
    ...
    const style = computed(() => {
      ...
      if (!size && !color)
        return {};
      return {
        fontSize: isUndefined(size) ? void 0 : addUnit$1(size),
        "--color": color
      };
    });
    return (_ctx, _cache) => {
...
var ElFocusTrap = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$1], ["__file", "focus-trap.vue"]]);
      ...
      return [
        {
          ...
          marginRight: addUnit$1(-((_b = (_a2 = props.offset) == null ? void 0 : _a2[0]) != null ? _b : 0)),
          marginTop: addUnit$1((_d = (_c = props.offset) == null ? void 0 : _c[1]) != null ? _d : 0)
        },
...
var Badge = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__file", "badge.vue"]]);
...
const resolveOptions = (options) => {
  ...
  if (isString(options.target)) {
    target = (_a2 = (void 0).querySelector(options.target)) != null ? _a2 : (void 0).body;
  } else {
...
var MessageBoxConstructor = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render], ["__file", "index.vue"]]);
...
var NotificationConstructor = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__file", "notification.vue"]]);
const notifications = {
  "top-left": [],
  "top-right": [],
  "bottom-left": [],
...
const _Feedback = class _Feedback {
  constructor() {
  ...
  // 确认窗体
  confirm(msg, title = "温馨提示", options) {
  ...
  closeLoading() {
    var _a2;
    (_a2 = this.loadingInstance) == null ? void 0 : _a2.close();
  }
};
__publicField(_Feedback, "instance", null);
...
function copy(str) {
  const aux = (void 0).createElement("textarea");
  aux.value = str;
  (void 0).body.appendChild(aux);
  aux.select();
  (void 0).execCommand("Copy");
  (void 0).body.removeChild(aux);
...
class EventManage {
  constructor() {
    __publicField(this, "callbacksMap");
...
var ContentTypeEnum = /* @__PURE__ */ ((ContentTypeEnum2) => {
  ContentTypeEnum2["EVENT_STREAM"] = "text/event-stream";
  ContentTypeEnum2["JSON"] = "application/json";
  ContentTypeEnum2["FORM_DATA"] = "multipart/form-data";
...
var RequestCodeEnum = /* @__PURE__ */ ((RequestCodeEnum2) => {
  ...
  RequestCodeEnum2[RequestCodeEnum2["LOGIN_EMPTY"] = -2] = "LOGIN_EMPTY";
  ...
  RequestCodeEnum2[RequestCodeEnum2["KEY_INVALID"] = 1200] = "KEY_INVALID";
  return RequestCodeEnum2;
})(RequestCodeEnum || {});
const createEvent = (type, data, errorType) => {
  const event = {
    type,
    data
  };
...
class Sse extends EventManage {
  ...
  async connect() {
    ...
    try {
      ...
      if (response.status === 200) {
        this.triggerEvent("open", response);
        const isJson = (_b = (_a2 = response.headers) == null ? void 0 : _a2.get("Content-Type")) == null ? void 0 : _b.includes(ContentTypeEnum.JSON);
        if (isJson) {
  ...
  triggerEvent(type, data, errorType) {
    var _a2;
    try {
      if (type === "open") {
        this.readyState = 1;
      ...
      (_a2 = this[`on${type}`]) == null ? void 0 : _a2.call(this, event);
      this.dispatchEvent(type, event);
    } catch (error) {
      console.error(error);
    }
  }
  async push(controller, reader) {
    try {
      ...
      if (done) {
        ...
        textValue.trim().split(DATA_PREFIX).forEach((text) => {
          var _a2, _b, _c;
          if (text) {
            const resultJson = parse$1(text);
            if (typeof resultJson !== "object") {
              return;
            }
            this.triggerEvent("message", resultJson);
            if (resultJson.error) {
              this.triggerEvent(
                "error",
                resultJson.error,
            ...
            const dataJson = {
              ...
              id: resultJson.id,
              index: (_a2 = choices[0]) == null ? void 0 : _a2.index,
              data: (_c = (_b = choices[0]) == null ? void 0 : _b.delta) == null ? void 0 : _c.content
            };
            if (dataJson.type) {
  ...
  read() {
    var _a2;
    const reader = (_a2 = this.response) == null ? void 0 : _a2.body.getReader();
    if (reader) {
      new ReadableStream({
        start: (controller) => {
          this.push(controller, reader);
...
class Request {
   ...
   */
  sse(fetchOptions, requestOptions) {
    var _a2, _b;
    ...
    if (((_a2 = mergeOptions.method) == null ? void 0 : _a2.toUpperCase()) === RequestMethodsEnum.GET && mergeOptions.params) {
      mergeOptions.url = `${mergeOptions.url}?${objectToQuery(
        mergeOptions.params
      )}`;
    }
    if (((_b = mergeOptions.method) == null ? void 0 : _b.toUpperCase()) === RequestMethodsEnum.POST) {
    ...
    const sseInstance = new Sse(mergeOptions.url, mergeOptions);
    sseInstance.addEventListener("error", (ev) => {
      var _a3;
      if (ev.errorType === "responseError") {
        responseInterceptorsHook == null ? void 0 : responseInterceptorsHook(
          {
            ...sseInstance.response,
            _data: {
              ...ev.data,
              msg: (_a3 = ev.data) == null ? void 0 : _a3.message
            },
            sse: true
          },
          mergeOptions
        ...
        responseInterceptorsCatchHook == null ? void 0 : responseInterceptorsCatchHook(ev);
      }
    });
    sseInstance.connect();
    return sseInstance;
   ...
   */
  // fetch暂时无法实现上传进度
  uploadFile(config, params, options) {
  ...
  const defaultOptions = {
    ...
    requestOptions: {
      ...
      requestInterceptorsHook(options) {
        ...
        if (isParamsToData && !Reflect.has(options, "body") && ((_a2 = options.method) == null ? void 0 : _a2.toUpperCase()) === RequestMethodsEnum.POST) {
          options.body = params;
          options.params = {};
        }
      ...
      async responseInterceptorsHook(response, options) {
        var _a2;
        if (response.sse) {
          const { msg: msg2, code: code2 } = response._data;
          switch (code2) {
            case 10006:
            case RequestCodeEnum.FAIL:
              msg2 && feedback.msgError(msg2);
              break;
          }
          return;
        }
        ...
        switch (code) {
          ...
          case RequestCodeEnum.LOGIN_FAILURE:
            userStore.logout();
            if (((_a2 = options.method) == null ? void 0 : _a2.toUpperCase()) === RequestMethodsEnum.POST) {
              userStore.toggleShowLogin(true);
            }
...
const fetch_CZvRlf0ZJN = /* @__PURE__ */ defineNuxtPlugin(() => {
...
const icons_1IP8D2uc6u = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const vconsole_S8cSrL3nch = /* @__PURE__ */ defineNuxtPlugin(async (nuxt) => {
});
const vue_query_JC9gnf7CA1 = /* @__PURE__ */ defineNuxtPlugin((nuxt) => {
  const vueQueryState = useState("vue-query");
  const queryClient = new QueryClient({
    defaultOptions: { queries: { staleTime: 60 * 60 * 1e3 } }
  });
...
const plugins = [
  unhead_BpoVZOGVGk,
  plugin$1,
  revive_payload_server_JAenfqojem,
  plugin,
...
const layouts = {
  blank: () => import('./blank-CuOPKrrH.mjs').then((m) => m.default || m),
  "components-account-bind-mobile": () => import('./bind-mobile-DCW2ViFa.mjs').then((m) => m.default || m),
  "components-account-bind-weixin": () => import('./bind-weixin-CghyAKzM.mjs').then((m) => m.default || m),
  "components-account-forgot-pwd": () => import('./forgot-pwd-DSRa74TH.mjs').then((m) => m.default || m),
  "components-account-hooks-use-captcha-effect": () => import('./useCaptchaEffect-C4yyV95H.mjs').then((m) => m.default || m),
  "components-account": () => import('./index-BDwPtStU.mjs').then((m) => m.default || m),
  "components-account-login": () => import('./index-BZwsOHV2.mjs').then((m) => m.default || m),
  "components-account-login-mailbox-login": () => import('./mailbox-login-DTfJ6zDd.mjs').then((m) => m.default || m),
  "components-account-login-mobile-login": () => import('./mobile-login-CIZyd954.mjs').then((m) => m.default || m),
  "components-account-login-weixin-login": () => import('./weixin-login-C37aKzsA.mjs').then((m) => m.default || m),
  "components-account-register": () => import('./index-SK82_cfs.mjs').then((m) => m.default || m),
  "components-account-tologin": () => import('./tologin-BQv8QnLK.mjs').then((m) => m.default || m),
  "components-aside": () => import('./index-Rg7R--Hc.mjs').then((m) => m.default || m),
  "components-aside-menu-item": () => import('./menu-item-syjwFhcv.mjs').then((m) => m.default || m),
  "components-aside-menu": () => import('./menu-kGe6aUVW.mjs').then((m) => m.default || m),
  "components-aside-nav": () => import('./nav-BWEmvwsg.mjs').then((m) => m.default || m),
  "components-aside-panel": () => import('./panel-CZST6D6c.mjs').then((m) => m.default || m),
  "components-customer": () => import('./index-NI1tubJF.mjs').then((m) => m.default || m),
  "components-customer-manual": () => import('./manual-B2oZtFmW.mjs').then((m) => m.default || m),
  "components-customer-online": () => import('./online-CTlEkafJ.mjs').then((m) => m.default || m),
  "components-footer": () => import('./index-DVowbRlP.mjs').then((m) => m.default || m),
  "components-header-application": () => import('./application-CIM2fKWn.mjs').then((m) => m.default || m),
  "components-header-fold": () => import('./fold-CHURezXp.mjs').then((m) => m.default || m),
  "components-header": () => import('./index-wmJMgVku.mjs').then((m) => m.default || m),
  "components-header-member-btn": () => import('./member-btn-MuRMgKHK.mjs').then((m) => m.default || m),
  "components-header-menu-item": () => import('./menu-item-DyOqt2KJ.mjs').then((m) => m.default || m),
  "components-header-menu": () => import('./menu-C91s3odr.mjs').then((m) => m.default || m),
  "components-header-notification": () => import('./notification-CMHE07wn.mjs').then((m) => m.default || m),
  "components-header-redeem-code-pop": () => import('./redeem-code-pop-abs7srJ_.mjs').then((m) => m.default || m),
  "components-header-title-logo": () => import('./title-logo-BNM0flCB.mjs').then((m) => m.default || m),
  "components-header-user-info": () => import('./user-info-l98cbsTN.mjs').then((m) => m.default || m),
  "components-header-user": () => import('./user-SBxKtT5H.mjs').then((m) => m.default || m),
  "components-notice": () => import('./index-D2jK_mUw.mjs').then((m) => m.default || m),
  "components-setting-drawer": () => import('./drawer-3xI8Gnm9.mjs').then((m) => m.default || m),
  "components-setting": () => import('./index-Dmkdl4WA.mjs').then((m) => m.default || m),
  "components-tabbar": () => import('./index-BKXlXc_X.mjs').then((m) => m.default || m),
  default: () => import('./default-BJz0XAT7.mjs').then((m) => m.default || m),
  "single-row": () => import('./single-row-BEgnQUJL.mjs').then((m) => m.default || m)
};
...
const generateVars = (color, type = "primary", isDark = false) => {
  const colos = {
    [`--el-color-${type}`]: color
  };
...
const setTheme = (options, isDark = false) => {
  ...
  theme = `:root{${theme}}`;
  let style = (void 0).getElementById(themeId);
  if (style) {
  ...
  style.innerHTML = theme;
  (void 0).head.append(style);
};
const useSettingStore = /* @__PURE__ */ defineStore({
  id: "setting",
  state: () => {
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    [__temp, __restore] = withAsyncContext(() => appStore.init()), await __temp, __restore();
    ...
    if (!appStore.getIsInstall) {
      (void 0).location.replace("/install/install.php");
    } else if (!appStore.getPcStatus) {
      [__temp, __restore] = withAsyncContext(() => router.replace({ path: "/empty" })), await __temp, __restore();
    }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_ElConfigProvider, mergeProps(config, _attrs), {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Bxx-loQK.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-MUr3DYvC.mjs').then((r) => r.default || r));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@3.12.4_@parcel+watcher@2.5.0_@types+node@18.19.68_db0@0.2.1_eslint@8.41.0_ioredis@5.4.2__w3zwnsg5icbmgrcqcmuo7352zq/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@3.12.4_@parcel+watcher@2.5.0_@types+node@18.19.68_db0@0.2.1_eslint@8.41.0_ioredis@5.4.2__w3zwnsg5icbmgrcqcmuo7352zq/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { UPDATE_MODEL_EVENT as $, feedback as A, vLoading as B, useLocale as C, CloseComponents as D, ElInput as E, FOCUS_TRAP_INJECTION_KEY as F, useDeprecated as G, ElOverlay as H, ElFocusTrap as I, useSameTarget as J, mutable as K, LOCAL_ICON_PREFIX as L, full_screen_default as M, scale_to_original_default as N, useZIndex as O, arrow_left_default as P, arrow_right_default as Q, zoom_out_default as R, zoom_in_default as S, refresh_left_default as T, refresh_right_default as U, keysOf as V, useAttrs as W, isElement as X, getScrollContainer as Y, iconPropType as Z, _export_sfc as _, useRouter as a, getAiModels as a$, isBoolean as a0, useId as a1, useGlobalConfig as a2, useLockscreen as a3, defaultNamespace as a4, useAppStore as a5, useSizeProp as a6, CHANGE_EVENT as a7, useFormDisabled as a8, useFormItem as a9, circle_check_filled_default as aA, warning_filled_default as aB, circle_close_filled_default as aC, info_filled_default as aD, useNuxtApp as aE, asyncDataDefaults as aF, createError as aG, search_default as aH, getDecorate as aI, UUID_KEY as aJ, uniqueId as aK, AUTHORIZATION_KEY as aL, uploadFile as aM, document_default as aN, circle_check_default as aO, check_default as aP, delete_default as aQ, entriesOf as aR, formContextKey as aS, getProp as aT, uploadImage as aU, baseUrl as aV, addClass as aW, removeClass as aX, hasClass as aY, flattedChildren as aZ, more_default as a_, useFormItemInputId as aa, buildProp as ab, useGetDerivedNamespace as ac, useIdInjection as ad, formItemContextKey as ae, EVENT_CODE as af, useRoute as ag, __nuxt_component_0 as ah, INPUT_EVENT as ai, isUndefined as aj, arrow_down_default as ak, minus_default as al, arrow_up_default as am, plus_default as an, ElMessage as ao, withInstallDirective as ap, d_arrow_left_default as aq, more_filled_default as ar, d_arrow_right_default as as, isKorean as at, useFocusController as au, useEmptyValues as av, ValidateComponentsMap as aw, scrollIntoView as ax, circle_close_default as ay, useEmptyValuesProps as az, navigateTo as b, logout as b$, ElMessageBox as b0, loading_default as b1, isPropAbsent as b2, __nuxt_component_1$1 as b3, __nuxt_component_1 as b4, isValidComponentSize as b5, back_default as b6, useState as b7, putAvatarSava as b8, getAvatarDetail as b9, handleClientCallback as bA, caret_right_default as bB, smsSend as bC, SMSEnum as bD, userBindMobile as bE, sendEmailCode as bF, forgotPassword as bG, accountDetail as bH, accountList as bI, userEdit as bJ, editUserInfo as bK, cancelled as bL, noticeAllRead as bM, ElBadge as bN, noticeLists as bO, isEmpty as bP, clock_default as bQ, calendar_default as bR, getStyle as bS, register as bT, getWxCode as bU, checkTicket as bV, terminal as bW, login as bX, captcha as bY, checkRedeemCode as bZ, useRedeemCode as b_, putVideoRename as ba, checkVideoStatus as bb, getAvatarList as bc, getBgCategory as bd, getBgList as be, getDubList as bf, getEffectList as bg, getMusicCategory as bh, getMusicList as bi, getMapsList as bj, getProspectsList as bk, delVideoRecord as bl, getVideoRecordsList as bm, ElNotification as bn, copy as bo, ShareSquareEnum as bp, promotion_default as bq, isExternal as br, useSettingStore as bs, LoginPopupTypeEnum as bt, objectToQuery as bu, getMindMapConfig as bv, PolicyAgreementEnum as bw, getPolicy as bx, wechatoa as by, formatPrice as bz, useRuntimeConfig as c, useCookie as c0, NOTICE_KEY as c1, ElButton as d, entry$1 as default, addUnit as e, EL_ICON_PREFIX as f, ElIcon as g, buildProps as h, useNamespace as i, definePropType as j, useAriaProps as k, isNumber as l, addUnit$1 as m, nuxtLinkDefaults as n, debugWarn as o, picture_filled_default as p, withNoopInstall as q, resolveRouteObject as r, componentSizes as s, throwError as t, useHead as u, useFormSize as v, withInstall as w, close_default as x, defineStore as y, useUserStore as z };
