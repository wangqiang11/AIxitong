...
import { a as shareDraw, b as getSquareCategory } from './task_reward-DRop0WtE.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "share-popup" }, _attrs))} data-v-33ac0b85>`);
      _push(ssrRenderComponent(Popup, {
        ...
        footer: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="dialog-footer flex justify-center pb-2" data-v-33ac0b85${_scopeId}>`);
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="h-[100px]" data-v-33ac0b85${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/draw/components/common/draw-share.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const DrawShare = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-33ac0b85"]]);

export { DrawShare as default };
//# sourceMappingURL=draw-share-CqwfKs_W.mjs.map
