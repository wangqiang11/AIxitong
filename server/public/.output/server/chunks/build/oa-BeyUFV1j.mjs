...
import { defineComponent, shallowRef, toRefs, reactive, watch, withCtx, createTextVNode, mergeProps, unref, createVNode, isRef, useSSRContext } from 'vue';
...
import _sfc_main$3 from './oa-config-C3zr4Tkt.mjs';
              ...
              default: withCtx(({ row }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_el_button, {
                    ...
                    onClick: ($event) => {
                      var _a;
                      return (_a = unref(oaConfigRef)) == null ? void 0 : _a.open(row.apikey);
                    }
                  }, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/application/robot/_components/app-release/oa.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=oa-BeyUFV1j.mjs.map
