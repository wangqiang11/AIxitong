...
import MenuItem from './menu-item-DyOqt2KJ.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const navList = computed(() => {
      var _a;
      return ((_a = appStore.getHeaderConfig.nav) == null ? void 0 : _a.filter((item) => item.isShow)) || [];
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "menu" }, _attrs))} data-v-10dc3ac7>`);
      _push(ssrRenderComponent(_component_el_menu, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<!--[-->`);
            ssrRenderList(unref(navList), (item) => {
            ...
            return [
              (openBlock(true), createBlock(Fragment, null, renderList(unref(navList), (item) => {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("layouts/components/header/menu.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const Menu = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-10dc3ac7"]]);

export { Menu as default };
//# sourceMappingURL=menu-C91s3odr.mjs.map
