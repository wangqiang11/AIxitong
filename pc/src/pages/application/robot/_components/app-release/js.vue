<template>
    <el-page-header content="发布JS嵌入" @back="emit('back')" />
...
const jsEmbeddingRef = shallowRef<InstanceType<typeof JsEmbedding>>()
...
const jsEmbedding = (row: any) => {
    setCurrentData(row)
    jsEmbeddingRef.value?.open()
}
