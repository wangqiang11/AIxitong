            ...
            <el-card shadow="never" class="!border-none">
                ...
                <el-form-item label="注册方式" prop="register_way">
                    <div>
                        <el-checkbox-group v-model="formData.register_way">
                            <el-checkbox label="3">微信注册</el-checkbox>
                            <el-checkbox label="1">手机号注册</el-checkbox>
                ...
                <el-form-item label="登录方式" prop="loginWay">
                    <div>
                        <el-checkbox-group v-model="formData.login_way">
                            ...
                            <el-checkbox label="1">手机号登录</el-checkbox>
                            <el-checkbox label="2">邮箱登录</el-checkbox>
                        </el-checkbox-group>
                ...
                <el-form-item label="强制绑定手机号" prop="coerce_mobile">
                    <div>
                        ...
                        <div class="form-tips">
                            <div>1、使用微信/邮箱注册方式注册登录时，要先绑定手机号</div>
                ...
                <el-form-item label="政策协议" prop="is_agreement">
                    <div>
                        <el-switch
                            v-model="formData.is_agreement"
                            :active-value="1"
                            :inactive-value="0"
                        />
                        <span class="mt-1 ml-2">
                            {{ formData.is_agreement ? '开启' : '关闭' }}
                        </span>

                        <div class="form-tips">用户登录/注册时，是否显示服务协议和隐私政策</div>
                    </div>
                </el-form-item>
            </el-card>
