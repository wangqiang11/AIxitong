...
<template>
    <div class="website-filing">
            ...
            <el-form ref="form" class="ls-form" label-width="100px">
                ...
                >
                    <div class="py-4 bg-fill-lighter">
                        <el-form-item label="显示名称" prop="key">
                            <div class="w-80">
                                <div>
                        ...
                        <el-form-item label="图标" prop="icon">
                            <div class="w-80">
                                <material-picker v-model="item.icon" size="60px" :limit="1" />
                                <div class="form-tips">
                                    建议尺寸：宽60px*高60px。jpg，jpeg，png格式
                                </div>
                            </div>
                        </el-form-item>
                        <el-form-item label="图标位置" prop="icp_link">
                            <div class="w-80">
                                <el-radio-group :model-value="1">
                                    <el-radio :label="1" size="large">左边</el-radio>
                                    <!-- <el-radio label="2" size="large">右边</el-radio> -->
                                </el-radio-group>
                            </div>
                        </el-form-item>
                    </div>
        ...
        <footer-btns v-perms="['setting.website/setCopyright']">
