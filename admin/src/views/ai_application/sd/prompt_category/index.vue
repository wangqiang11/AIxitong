<template>
    <div>
        ...
        <el-card class="!border-none mt-4" shadow="never">
            <div>
                <el-button
                    v-perms="['draw.draw_prompt_category/add']"
                    type="primary"
                    @click="openPop('add')"
                >
                    <template #icon>
            ...
            >
                ...
                <el-table-column
                    label="状态"
                    min-width="100"
                    v-perms="['draw.draw_prompt_category/status']"
                >
                ...
                <el-table-column label="操作" width="150" fixed="right">
                    <template #default="{ row }">
                        <el-button
                            v-perms="['draw.draw_prompt_category/edit']"
                            type="primary"
                            link
                        ...
                        <el-button
                            v-perms="['draw.draw_prompt_category/delete']"
                            type="danger"
                            link
...
const getLists = async () => {
    try {
        const data = await getDrawCategoryList(queryParams);
        pager.lists = data;
    } catch (error) {
