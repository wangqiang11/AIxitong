    ...
    <div>
        ...
        <el-card class="!border-none mt-4" shadow="never">
            ...
            >
                ...
                <el-table-column label="搜索模式" prop="model" min-width="120" />
                <el-table-column label="搜索类型" prop="type" min-width="120" />
                ...
                <el-table-column label="操作" min-width="180" fixed="right">
                    <template #default="{ row }">
                        <el-button type="primary" link @click="openPop(row.markdown)">
                            查看回复
                        </el-button>
...
<script lang="ts" setup name="searchRecord">
import { getSearchRecord, delSearchRecord } from '@/api/ai_application/search'
