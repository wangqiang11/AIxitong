    ...
    <div>
        <el-card shadow="never" class="!border-none">
            <el-tabs v-model="activeTab">
                <el-tab-pane label="MJ基础配置" name="configs" lazy>
                    <el-form
                        label-width="150px"
                        ref="sdConfigsRef"
                        :model="configs"
                    ...
                    >
                        ...
                        <el-form-item label="AI渠道" prop="channel">
                            <div>
                                <div class="flex">
                                    <el-radio-group v-model="configs.channel">
                                        <el-radio label="mj_goapi">Goapi</el-radio>
                                        <el-radio label="mj_acedata">AceData</el-radio>
                                    </el-radio-group>
                                </div>
                                <div
                                    class="form-tips !text-[14px]"
                                    v-if="configs?.website_list[configs.channel]"
                                >

                                  开通地址：
                                    <a v-if="configs?.website_list[configs.channel]"
                                        class="text-primary"
                                        target="_blank"
                                        :href="configs?.website_list[configs.channel]"
                                    >
                                        前往开通
                                    </a>
                                </div>
                        ...
                        >
                            <div class="w-[400px]">
                                ...
                                <div class="form-tips !text-[14px]">
                                    ...
                                    <span class="ml-3 text-primary cursor-pointer"
                                          v-copy="'我会用任何语言和你交流，你只需将我的话翻译为英语，不要解释我的话或者回复其他信息，请立刻将我的话翻译返回，我的话是:{prompt}'">
                                        复制示例指令
                                    </span>
                                </div>
                            </div>
                        ...
                        <el-form-item label="超时处理时长" prop="file_size">
                            <div>
                                <el-input-number
                ...
                <el-tab-pane label="应用计费" name="charging" lazy>
                    ...
                    >
                        ...
                        <el-form-item label="生成模式" class="is-required" prop="process_mode">
                            <div>
                                <el-radio-group v-model="charging.process_mode">
                                    <el-radio label="relax">慢速(relax)</el-radio>
                                    <el-radio label="fast">快速(fast)</el-radio>
                                    <el-radio label="turbo">极速(turbo)</el-radio>
                                </el-radio-group>
                                <div class="form-tips !text-[14px] flex items-center">
                                    不同模式计费不同，按需选择生成模式。
                                </div>
