...
<!--                </el-button>-->
                <el-button
                    v-perms="['video.videoSquare/verifyStatus']"
                    type="default"
                    :plain="true"
                ...
                <el-button
                    v-perms="['video.videoSquare/removeCategory']"
                    type="default"
                    :plain="true"
                    :disabled="!multipleSelection.length"
            ...
            >
                ...
                <el-table-column label="视频场景/描述词" prop="prompt" min-width="280">
                    <template #default="{ row }">
                        <Popup
                            ref="popRef"
                            title="提示词"
                        ...
                        >
                            ...
                            <div class="mt-[6px]">{{ row.prompt || '-' }}</div>
                        </Popup>
                    </template>
                </el-table-column>
                ...
                <el-table-column
                    label="是否显示"
                    min-width="100"
                    v-perms="['video.videoSquare/isShow']"
                >
                    <template #default="{ row }">
                        <el-switch
                ...
                <el-table-column label="操作" min-width="180" fixed="right">
                    <template #default="{ row }">
                        <el-button
                            v-perms="['video.videoSquare/edit']"
                            type="primary"
                            link
...
<script lang="ts" setup name="videoSquareLists">
import {
    getVideoSquareList,
    delVideoSquare,
    editVideoSquareStatus,
...
const changeStatus = async (id: any) => {
    try {
        await editVideoSquareStatus({ id })
    } catch (error) {
