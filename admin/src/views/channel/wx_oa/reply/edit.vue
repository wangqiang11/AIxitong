    ...
    <div class="edit-popup">
        ...
        >
            ...
            >
                ...
                <el-form-item label="关键词" prop="keyword" v-if="formData.reply_type == 2">
                    <div class="flex-1">
                        <el-input
                            ...
                            placeholder="请输入关键词"
                        />
                        <div class="form-tips">添加多条关键词记录按回车换行</div>
                    </div>
                </el-form-item>
                ...
                <el-form-item
                    :label="formData.content_type !== 3 ? '回复内容' : '链接地址'"
                    prop="content"
                >
                    <div class="flex-1">
                        <el-input
                            ...
                            show-word-limit
                            :placeholder="`请输入${
                                formData.content_type !== 3 ? '回复内容' : '链接地址'
                            }`"
                        />
                    </div>
                </el-form-item>
                <el-form-item
                    label="回复图片"
                    prop="content_image"
                    v-if="formData.content_type == 2"
                >
                    <materialPicker v-model="formData.content_image" />
                </el-form-item>
...
const { lockFn: handleSubmit } = useLockFn(async () => {
    ...
    mode.value == 'edit' ? await oaReplyEdit(data) : await oaReplyAdd(data)
