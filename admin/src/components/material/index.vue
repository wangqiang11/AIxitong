    ...
    <div class="material" v-loading="pager.loading">
        ...
        <div class="material__center flex flex-col">
            ...
            <div class="material-center__content flex flex-col flex-1 mb-1 min-h-0">
                <el-scrollbar v-if="pager.lists.length && listShowType == 'normal'">
                ...
                >
                    ...
                    <el-table-column label="图片" width="100">
                        <template #default="{ row }">
                            <file-item :uri="row.uri" file-size="50px" :type="type" />
                        </template>
                    </el-table-column>
                        ...
                        <li class="mb-4" v-for="item in select" :key="item.id">
                            <div class="select-item">
                                <del-wrap @close="cancelSelete(item.id)">
                                    <file-item :uri="item.uri" file-size="100px" :type="type" />
                                </del-wrap>
                            </div>
                        </li>
                    </ul>
...
const { pageSize, data } = toRefs(props)
const {
    tableRef,
    listShowType,
    moveId,
    ...
    selectAll,
    handleFileRename
} = useFile(cateId, typeValue, limit, pageSize, data)
