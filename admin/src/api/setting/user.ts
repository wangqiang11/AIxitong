...
export function getUserSetup() {
    return request.get({ url: '/setting.user/getConfig' })
}
...
export function setUserSetup(params: { default_avatar: string }) {
    return request.post({ url: '/setting.user/setConfig', params })
}
...
export function getLogin() {
    return request.get({ url: '/setting.user/getRegisterConfig' })
}
...
export function setLogin(params: LoginSetup) {
    return request.post({ url: '/setting.user/setRegisterConfig', params })
}
